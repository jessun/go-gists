...
func UserInfo(prefix Prefix, msg string, args ...interface{}) { //NO_DUPL_CHECK
...
func DetailSystem(prefix Prefix, msg string, args ...interface{}) {
	Write(prefix).DetailSystem(msg, args...).done(calldepth)
}

// NOTE: this function only used for debug, not for production
func Debug(prefix Prefix, msg string, args ...interface{}) {
	Write(prefix).Debug(msg, args...).done(calldepth)
}

func Errorf(prefix Prefix, msg string, args ...interface{}) {
	Write(prefix).Errorf(msg, args...).done(calldepth)
}

func UserInfoDilute1(prefix Prefix, diluteKey, msg string, args ...interface{}) { //NO_DUPL_CHECK
...
func DetailSystemDilute1(prefix Prefix, diluteKey, msg string, args ...interface{}) {
	WriteDilute(prefix, diluteKey, 10, 60).DetailSystem(msg, args...).done(calldepth)
}
...
func DetailSystemDilute2(prefix Prefix, diluteKey, msg string, args ...interface{}) {
	WriteDilute(prefix, diluteKey, 60, 300).DetailSystem(msg, args...).done(calldepth)
}

func BriefDilute(prefix Prefix, diluteDurationSeconds, diluteCheckpointSeconds int, diluteKey, msg string, args ...interface{}) {
	WriteDilute(prefix, diluteKey, diluteDurationSeconds, diluteCheckpointSeconds).Brief(msg, args...).done(calldepth)
}
