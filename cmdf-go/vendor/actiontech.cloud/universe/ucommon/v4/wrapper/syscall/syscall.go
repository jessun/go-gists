...
// wrapper for syscall.Setresgid. descriptions simply describes why to call this func(empty is allowed), eg: destn=clear_gid
func Setresgid(stage *log.Stage, rgid, egid, sgid int, descriptions ...string) (err error) {
	from := wrapper.GetCurrentTimestamp()
...
// wrapper for syscall.Setresuid. descriptions simply describes why to call this func(empty is allowed), eg: destn=clear_uid
func Setresuid(stage *log.Stage, ruid, euid, suid int, descriptions ...string) (err error) {
	from := wrapper.GetCurrentTimestamp()
